module filepaths
  ...
  character (len=*), parameter :: archive_raw_harpn='/Users/malavolta/Astro/TR2_memento/HARPN/data/'
  character (len=*), parameter :: archive_red_harpn='/Users/malavolta/Astro/TR2_memento/HARPN/data/'

  character (len=*), parameter :: archive_raw_harps='/Users/malavolta/Astro/TR2_memento/HARPS/data/'
  character (len=*), parameter :: archive_red_harps='/Users/malavolta/Astro/TR2_memento/HARPS/data/'

  character (len=*), parameter :: &
       make_atms_m4='/Users/malavolta/Astro/CODE/PreMoog/modprog_1/makekurandy/makekurucz3_cl_aM4.go', &
       make_atms='/Users/malavolta/Astro/CODE/PreMoog/modprog_1/makekurandy/makekurucz3_cl.go', &
       moog_call='/Users/malavolta/Astro/CODE/MOOG/MOOGSILENT > /dev/null ', &
       moog2013_call='/Users/malavolta/Astro/CODE/MOOG/MOOG2013_1/MOOGSILENT > /dev/null'

  character (len=*), parameter :: &
       code_path='/Users/malavolta/Astro/CODE/' , &
       routinesF90_path='/Users/malavolta/Astro/CODE/Routines_F90/' , &
       tables_path='/Users/malavolta/Astro/CODE/Routines_F90/tables/' , &
       masks_path='/Users/malavolta/Astro/CODE/Routines_F90/masks/' , &
       stellib_path='/media/TR1/malavolta/STELLAR_LIBS/', &
       data_path='/Users/malavolta/data/'
  ...
  character (len=*), parameter :: work_dir_common = '/Users/malavolta/moog_workdir/wd_1/'
  character (len=*), parameter :: temp_file1='file_temp1.dat', temp_file2='file_tmp2.dat', temp_file3='file_tmp3.dat'

  character (len=*), parameter :: batch_file='batch.par', buffer_file='buffer.source'
