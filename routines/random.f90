MODULE random
  ! Modifies version by Luca Malavolta:
  ! seed_random_number -> no human input is required anymore, random seeds are 
  !                       generated by using clock time
  !
...
110 IF (pp > half) ix = n - ix
  ...
  SUBROUTINE seed_random_number()
    ...
    ! Modified part (Luca Malavolta, from Andrea Cunial subroutines)
